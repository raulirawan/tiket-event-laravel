        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                 @if($errors->any())
                    ...
                    @endif
                <form method="POST" action="{{ route('event.admin.index.event.update.check.out', $event->slug) }}" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                    @csrf
                    @method('PUT')
